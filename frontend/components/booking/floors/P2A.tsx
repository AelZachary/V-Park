      ...
      <View style={styles.rowGroup}>
        ...
        <View style={styles.sideColumn}>
          ...
          <View style={styles.block3Rows}>
            ...
            <ParkingSlot 
              slot="P1A-A2" 
              status={resolveSlotStatus("P1A-A2", "available", slotStatuses, selectedSlot)} 
              side="left" 
              onPress={() => onSelectSlot("P1A-A2", "available")} 
            />
            <ParkingSlot 
              slot="P1A-A3" 
          ...
          <View style={styles.block3Rows}>
            ...
            <ParkingSlot 
              slot="P1A-A11" 
              status={resolveSlotStatus("P1A-A11", "available", slotStatuses, selectedSlot)} 
              side="left" 
              onPress={() => onSelectSlot("P1A-A11", "available")} 
            />
            <ParkingSlot 
              slot="P1A-A12" 
