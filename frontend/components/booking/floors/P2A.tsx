...
export default function P2A({ selectedSlot, onSelectSlot, slotStatuses }: FloorProps) {
  return (
    <View style={styles.parkingLayout}>
      <View style={styles.rowGroup}>
        ...
        <View style={styles.sideColumn}>
          ...
          <View style={styles.block3Rows}>
            <ParkingSlot disabled={false}
              slot="L1" 
              status={resolveSlotStatus("L1", "online", slotStatuses, selectedSlot)} 
              side="left" 
              onPress={() => onSelectSlot("L1", resolveSlotStatus("L1", "online", slotStatuses, selectedSlot))} 
            />
            <ParkingSlot disabled={false}
              slot="L2" 
          ...
          <View style={styles.block3Rows}>
            <ParkingSlot disabled={false}
              slot="L4" 
              status={resolveSlotStatus("L4", "online", slotStatuses, selectedSlot)} 
              side="left" 
              onPress={() => onSelectSlot("L4", resolveSlotStatus("L4", "online", slotStatuses, selectedSlot))} 
            />
            <ParkingSlot disabled={false}
              slot="L5" 
          ...
          <View style={styles.block3Rows}>
            ...
            <ParkingSlot disabled={false}
              ...
              side="left" 
              onPress={() => onSelectSlot("L8", resolveSlotStatus("L8", "online", slotStatuses, selectedSlot))} 
            />
            <ParkingSlot disabled={false}
              slot="L9" 
          ...
          <View style={styles.block3Rows}>
            ...
            <ParkingSlot disabled={false}
              slot="L15" 
              status={resolveSlotStatus("L15", "online", slotStatuses, selectedSlot)} 
              side="left" 
              onPress={() => onSelectSlot("L15", resolveSlotStatus("L15", "online", slotStatuses, selectedSlot))} 
            />
          </View>
          <View style={styles.groupDividerLeft} />
          ...
          <View style={styles.block3Rows}>
            <ParkingSlot disabled={false}
              slot="L22" 
              status={resolveSlotStatus("L22", "online", slotStatuses, selectedSlot)} 
              side="left" 
              onPress={() => onSelectSlot("L22", resolveSlotStatus("L22", "online", slotStatuses, selectedSlot))} 
            />
            <ParkingSlot disabled={false}
              slot="L23" 
            ...
            <ParkingSlot disabled={false}
              slot="L24" 
              status={resolveSlotStatus("L24", "online", slotStatuses, selectedSlot)} 
              side="left" 
              onPress={() => onSelectSlot("L24", resolveSlotStatus("L24", "online", slotStatuses, selectedSlot))} 
            />
          </View>
          <View style={styles.groupDividerLeft} />
          ...
          <View style={styles.block3Rows}>
            ...
            <ParkingSlot disabled={false}
              ...
              side="left" 
              onPress={() => onSelectSlot("L26", resolveSlotStatus("L26", "available", slotStatuses, selectedSlot))} 
            />
            <ParkingSlot disabled={false}
              slot="L27" 
              status={resolveSlotStatus("L27", "available", slotStatuses, selectedSlot)} 
              side="left" 
              onPress={() => onSelectSlot("L27", resolveSlotStatus("L27", "available", slotStatuses, selectedSlot))} 
            />
          </View>
          <View style={styles.groupDividerLeft} />
        </View>
        ...
        <View style={styles.roadSection}>
          ...
          {/* Teks P1A Atas */}
          <Text style={styles.floorText}>P2A</Text>
        ...
        <View style={styles.sideColumn}>
          ...
          <View style={styles.block3Rows}>
            ...
            <ParkingSlot disabled={false}
              slot="R3" 
              status={resolveSlotStatus("R3", "online", slotStatuses, selectedSlot)} 
              side="right" 
              onPress={() => onSelectSlot("R3", resolveSlotStatus("R3", "online", slotStatuses, selectedSlot))} 
            />
          </View>
          ...
          <View style={styles.routeLabelWrapper}>
            <Text style={styles.routeTextSmall}>P2A =› P3</Text>
          </View>

          <View style={styles.spacerSlot} />

          <View style={styles.routeLabelWrapper}>
            <Text style={styles.routeTextSmall}>P2A =› P2</Text>
          </View>
          <View style={styles.horizontalSmallDividerRight} />
          ...
          <View style={styles.block3Rows}>
            ...
            <ParkingSlot disabled={false}
              slot="R12" 
              status={resolveSlotStatus("R12", "online", slotStatuses, selectedSlot)} 
              side="right" 
              onPress={() => onSelectSlot("R12", resolveSlotStatus("R12", "online", slotStatuses, selectedSlot))} 
            />
          </View>
          <View style={styles.groupDividerRight} />
          ...
          <View style={styles.block3Rows}>
            <ParkingSlot disabled={false}
              slot="R19" 
              status={resolveSlotStatus("R19", "online", slotStatuses, selectedSlot)} 
              side="right" 
              onPress={() => onSelectSlot("R19", resolveSlotStatus("R19", "online", slotStatuses, selectedSlot))} 
            />
            <ParkingSlot disabled={false}
              slot="R20" 
            ...
            <ParkingSlot disabled={false}
              slot="R21" 
              status={resolveSlotStatus("R21", "online", slotStatuses, selectedSlot)} 
              side="right" 
              onPress={() => onSelectSlot("R21", resolveSlotStatus("R21", "online", slotStatuses, selectedSlot))} 
            />
          </View>
